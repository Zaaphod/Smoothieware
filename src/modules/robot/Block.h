...
class Block {
    public:
        ...
        using tickinfo_t= struct {
            int64_t steps_per_tick; // 2.30 fixed point
            int64_t counter; // 2.30 fixed point
            int64_t acceleration_change; // 2.30 fixed point signed
            int64_t deceleration_change; // 2.30 fixed point
            int64_t plateau_rate; // 2.30 fixed point
